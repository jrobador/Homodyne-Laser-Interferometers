...
[displacement_without_correction_continuo_original,counter_1] = a_tan2(x_continuo,y_continuo);
[displacement_without_correction_continuo,counter_2] = optimal_counter_test_a_tan2(x_continuo,y_continuo);



[displacement_without_correction_discreto_original,counter_3] = a_tan2(x_discreto,y_discreto);
[displacement_without_correction_discreto,counter_4] = optimal_counter_test_a_tan2(x_discreto,y_discreto);
...
figure
plot(t_line_continuo,counter_1)
hold all 
plot(t_line_continuo,counter_2)
hold all 
plot(t_line_discreto,counter_3)
hold all 
plot(t_line_discreto,counter_4)
